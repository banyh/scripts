...
# Add lavf support to x264 # This allows x264 to accept just about any input
# that FFmpeg can handle and is useful if you want to use x264 directly. See a
# more detailed explanation of what this means.
cd ~/x264
make distclean
